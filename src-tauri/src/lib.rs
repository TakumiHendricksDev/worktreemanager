...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_database_connections,
            commands::connect_database,
            commands::disconnect_database,
            commands::database_schemas,
            commands::database_relations,
            commands::database_columns,
            commands::run_database_query,
            commands::database_table_page,
            commands::cancel_database_query,
