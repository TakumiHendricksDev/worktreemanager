...
maintainer through
[GitHub's private reporting](https://github.com/TakumiHendricksDev/worktreemanager/security/advisories/new),
which is a private channel visible only to the maintainer, or by contacting
[@TakumiHendricksDev](https://github.com/TakumiHendricksDev) directly on GitHub.
...
This is a small project with a single maintainer. That is worth being plain about: reports go
to one person, and if that person is the problem, GitHub's own
